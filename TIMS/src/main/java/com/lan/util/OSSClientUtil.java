...
public class OSSClientUtil {
    public static ProjectVO getProject(HttpServletRequest request,ProjectVO projectVO){
        Map map=new HashMap();
        try {
        ...
        projectVO.setProjectId(Integer.valueOf((String)(map.get("id"))));

        OSSClientUtil ossClientUtil=new OSSClientUtil();
        String url = ossClientUtil.getImgUrl(headPortrait);
        projectVO.setUploadAddress(url);
